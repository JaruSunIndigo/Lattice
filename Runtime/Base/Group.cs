...
{
    /// <summary>Group the selected node when created</summary>
    [Serializable]
    public class Group
    {
        public string title;
        ...
        /// <summary>Store the GUIDs of the node in the group</summary>
        ...
        /// <summary>Create a new group with a title and a position</summary>
        ...
        /// <summary>Called when the Group is created</summary>
